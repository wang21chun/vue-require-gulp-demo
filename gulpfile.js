    ...
    return gulp.src([
        ...
        .pipe(amdOptimize("App", {
            ...
            paths: {
                ...
                VueAnimatedList: 'lib/vue-animated-list/vue-animated-list',
                Utile:'js/utile/utile',
                jquery:'lib/jquery.min',
                App: 'js/main/main',
                IndexHead: 'js/index/indexHead',
                IndexList: 'js/index/indexList',
                IndexPage: 'js/index/indexPage',
...
gulp.task('connect', function() {
    connect.server({
        root: [config.base,config.html,config.dist],
        port: 8080,
        host: 'localhost',
        livereload: true
    });
